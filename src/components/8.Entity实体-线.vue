...
onMounted(() => {
  ...
  const polyline = viewer.entities.add({
    polyline: {
      positions: Cartesian3.fromDegreesArray([120,20, 121,20, 121,20.5]), // a返回笛卡尔坐标数组
      width: 10,
      material: Color.YELLOW
    },
  })
  console.log("fromDegreesArray", Cartesian3.fromDegreesArray([120,20, 121,20, 121,20.5]));
